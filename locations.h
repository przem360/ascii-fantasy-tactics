...
// rewritten locations: 5, 7, 9, 11
// 
struct locations rooms[36] = {
    {1,{4,6},"Entry hall","This large room has a row of heavy, cobweb-laden columns down each side.\nThe floor is dusty, and you can clearly see a beaten path to \n the door on the far side of the room.", "Nothing to do here.",0,0,0,0,/* a */0,/* c */102,0,2,0},
    {2,{4,4},"Secret room","Description yet to come...",  "Also yet to come",1,0,0,0,/* a */0,/* c */1,0,0,0},
    {3,{6,5},"Room","A row of pegs such as one might hang a cloak \n from run along the wall to your left. The floor is \n littered with scraps of gray and brown fabric.", "Nothing here",0,0,0,0,/* a */0,/* c */101,1,103,5},
    {4,{4,3},"Storage room","This is obviously a storeroom. The walls to the left \n and right are lined with shelves containing what \n appear to be many bottles of wine. The far wall \n is lined with large barrels.", "Nothing here",0,0,0,0,/* a */0,/* c */103,0,0,0},
